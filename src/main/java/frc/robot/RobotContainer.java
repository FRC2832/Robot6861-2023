...
public class RobotContainer {
    ...
    private final Command blueCableEngageAutoCmd = new BlueCableEngageAuton(drivetrainObj, ingestorIntakeObj,
            gamePieceScoopObj);
    private final Command coopBalanceAutoCmd = new CoopBalanceAuton(ingestorIntakeObj, ingestorLiftObj,
            gamePieceScoopObj,
    ...
    public RobotContainer() {
        ...
        ingestorLiftObj.setDefaultCommand(new RaiseIngestorLiftCmd(ingestorLiftObj)); // TODO: Add Ingestor
                                                                                      // Intake
        ...
        if (Constants.INGESTOR_FAIL_STATUS) {
            switch (DriverStation.getAlliance()) {
                case Red:
                    ...
                    break;
                case Blue:
                    autonChooser.setDefaultOption("BLUE Default Substation Auton",
            ...
            // autonChooser.addOption("Coop Mobility Auton (both alliances)",
            // coopMobilityAutoCmd);
            switch (DriverStation.getAlliance()) {
                case Red:
                ...
                case Blue:
                    ...
                    // autonChooser.addOption("BLUE Default Substation Auton",
                    // blueDefaultSubstationAutoCmd);
                    autonChooser.addOption("BLUE Substation Cross Auton",
                            blueSubstationCrossAutoCmd);
                    // autonChooser.addOption("BLUE Default Cable Auton", blueDefaultCableAutoCmd);
    ...
    private void configureBindings() {
        ...
        /*
         * CommandBase setLeftEyePupil0 = eyeballObj.setEyes(new
         * EyeMovement(eyeballObj.getLeftEyeLid(), 0.0),
         * new EyeMovement(eyeballObj.getRightEyeLid(), eyeballObj.getRightEyePupil()),
         * Constants.WHITE);
         * CommandBase setLeftEyePupil1 = eyeballObj.setEyes(new
         * EyeMovement(eyeballObj.getLeftEyeLid(), 1.0),
         * new EyeMovement(eyeballObj.getRightEyeLid(), eyeballObj.getRightEyePupil()),
         * Constants.WHITE);
         * CommandBase setLeftEyeLid0 = eyeballObj.setEyes(new EyeMovement(0.0,
         * eyeballObj.getLeftEyePupil()),
         * new EyeMovement(eyeballObj.getRightEyeLid(), eyeballObj.getRightEyePupil()),
         * Constants.WHITE);
         * CommandBase setLeftEyeLid1 = eyeballObj.setEyes(new EyeMovement(1.0,
         * eyeballObj.getLeftEyePupil()),
         * new EyeMovement(eyeballObj.getRightEyeLid(), eyeballObj.getRightEyePupil()),
         * Constants.WHITE);
         * 
